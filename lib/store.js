...
const attendees = {
  'ATT-101': {
    ...
    role: '🏛️ Cabinet Secretary',
    company: 'Ministry of ICT & Digital Economy (Kenya)'
  },
  'ATT-102': {
    id: 'ATT-102',
    name: 'Dr. Kiprono Rotich',
    role: '🛡️ Head of Cybersecurity Division',
    company: 'Google Kenya'
  },
  'ATT-103': {
    id: 'ATT-103',
    name: 'Aisha Omondi',
    role: '💳 VP of Mobile Financial Services',
  ...
  'ATT-105': {
    id: 'ATT-105',
    name: 'Sarah Jenkins',
    role: '☁️ Director of Cloud Engineering',
  ...
  'ATT-106': {
    ...
    company: 'Dubai Future Foundation (UAE)'
  },
  'ATT-107': {
    id: 'ATT-107',
    name: 'Jean-Luc Dubois',
    role: '🌐 Managing Director',
    company: 'Orange Digital Center (France)'
  },
  'ATT-108': {
    id: 'ATT-108',
    name: 'Wanjiku Kamau',
    role: '🚀 Lead Fintech Architect',
    company: 'Equity Group Innovation Hub'
  }
};
